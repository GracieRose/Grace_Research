...
zip_start1 = "tar -xvzf /home/thelmuth/Results/clustering-bench/digits/baseline-uniform/csv/data"
zip_end = ".csv.tar.gz"

zip_start2 = "tar -xvzf /home/thelmuth/Results/clustering-bench/double-letters/lexicase/csv/data"
