...
for run in range(0, number_runs):
    intro_command = "echo Starting run; export PYTHONHOME=usr/bin; PYTHONPATH=/share/apps/python-3.6/bin/:/opt/sdsc/lib:/opt/sdsc/lib/python2.6/site-packages; cd /home/gwoolson/Grace_Research/; %s%i%s;" % (zip_start1, run, zip_end1)
