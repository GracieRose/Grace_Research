...
for run in range(0, number_runs):
    intro_command = "echo Starting run; cd /home/gwoolson/count-odds/; export PYTHONHOME=/usr; export PYTHONPATH=$PYTHONPATH:/opt/sdsc/lib:/opt/sdsc/lib/python2.6/site-packages:/usr/lib64/python26.zip:/usr/lib64/python2.6/plat-linux2:/usr/lib64/python2.6/lib-tk:/usr/lib64/python2.6/lib-old:/usr/lib64/python2.6/lib-dynload:/usr/lib/python2.6/site-packages/setuptools-0.6c11-py2.6.egg-info:/usr/lib64/python2.6:/usr/lib64/python2.6/site-packages:/usr/lib/python2.6/site-packages; %s%i%s; cd /home/gwoolson/Grace_Research/;" % (zip_start1, run, zip_end1)
    command = "python fly_export.py run%i.csv /home/gwoolson/count-odds/;" % (run)
